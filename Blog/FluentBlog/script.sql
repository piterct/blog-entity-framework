...
CREATE TABLE [PostTag] (
    ...
    CONSTRAINT [FK_PostTag_TagtId] FOREIGN KEY ([TagId]) REFERENCES [Post] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES (N'20211115065516_InitialCreation', N'5.0.12');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211115070854_addedGitHub', N'5.0.12');
GO
